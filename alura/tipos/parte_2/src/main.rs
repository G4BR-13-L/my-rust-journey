...
mod tipos_opcionais_parte_1;
mod tipos_opcionais_parte_2;
mod tamanho_dinamico_parte_1;
mod tamanho_dinamico_parte_2;
mod while_let;
...
fn main() {
    ...
    cores();
    tipos_opcionais_parte_1::conteudo_opcional();
    tipos_opcionais_parte_2::conteudo_opcional();
    tamanho_dinamico_parte_1::vetores();
    tamanho_dinamico_parte_2::vetores();
    while_let::vetores();
}
